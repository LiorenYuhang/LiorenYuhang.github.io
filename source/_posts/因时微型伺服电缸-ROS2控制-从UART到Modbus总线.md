...
| 行程 | 50 mm | 最大推拉力 | 50 N |
| 重量 | 50 g | 堵转推拉力 | 80 N |
| 空载速度 | 17 mm/s | 额定速度 | 8 mm/s |
| 重复定位精度 | ±0.1 mm | 最大自锁力 | 80 N |
| 力传感器范围 | ±100 N | 力传感器分辨率 | 1 N |
| 静态电流 | 0.05 A | 峰值电流 | 2 A |
| 供电电压 | DC 8V | 通信接口 | D 型（UART, LVTTL 3.3V） |
| 防护等级 | IP40 | 控制模式 | 位置/速度/力/电压/伺服/速度力控 |
